...
<body class="bg-zinc-50 min-h-screen flex items-center justify-center px-6 py-12">
    ...
    <div class="w-full max-w-sm">
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-zinc-500 mt-2">Welcome back, sign in to your account</p>
        </div>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center relative">
                        <input
                            ...
                            class="py-1.25 pl-2.5 pr-9 border w-full <?= !empty($errors['password']) ? 'border-red-400 focus:border-red-400 focus:ring-red-200' : 'border-zinc-300 focus:border-zinc-900 focus:ring-zinc-300' ?> rounded-[10px] text-base outline-none focus:ring-3 duration-200">
        ...
        <p class="text-center text-sm text-zinc-500 mt-6">
            ...
            <a href="/register" class="text-zinc-900 font-medium hover:underline duration-200">Register</a>
        </p>
    </div>
