...
<div class="flex flex-col gap-6">
    ...
    <div>
        ...
        <h1 class="text-2xl font-bold font-serif text-zinc-900">Add Book</h1>
        <p class="text-sm text-zinc-500 mt-1">Fill in the details to add a new book to the catalogue</p>
    </div>
    ...
    <form action="/admin/books" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
                ...
                <div class="bg-white border border-zinc-300 rounded-[10px] p-5 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <textarea
                            ...
                            class="py-1.25 px-2.5 border <?= !empty($errors['description']) ? 'border-red-400 focus:border-red-400 focus:ring-red-200' : 'border-zinc-300 focus:border-zinc-900 focus:ring-zinc-300' ?> rounded-[10px] text-sm outline-none focus:ring-3 duration-200 resize-none"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                id="published_on"
                                name="published_on"
                                value="<?= htmlspecialchars($old['published_on'] ?? '') ?>"
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input
                                ...
                                id="published_by"
                                name="published_by"
                                value="<?= htmlspecialchars($old['published_by'] ?? '') ?>"
